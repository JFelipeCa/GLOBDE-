# HU-010 — Asignación de horarios de trabajo

<!--
  ¿Qué? Historia de usuario que describe el requerimiento de asignación de horarios de trabajo.
...
| :--- | :--- |
| **ID** | HU-010 |
| **Título** | Asignación de horarios de trabajo |
| **Módulo** | Personal |
| **Prioridad** | Alta |
| **Estado** | Implementada |
| **RF Asociados** | RF-005 |
...
**Como** administrador,  
**quiero** configurar la jornada laboral de cada barbero,  
**para** asegurar que solo reciban citas en sus turnos hábiles.

---

## Criterios de Aceptación

### CA-HU-010.1 — Validación de datos y precondiciones
...
### CA-HU-010.2 — Flujo exitoso de operación
...
### CA-HU-010.3 — Control de accesos y persistencia
