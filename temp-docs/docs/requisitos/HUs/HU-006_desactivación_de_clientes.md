# HU-006 — Desactivación de clientes

<!--
  ¿Qué? Historia de usuario que describe el requerimiento de desactivación de clientes.
...
| :--- | :--- |
| **ID** | HU-006 |
| **Título** | Desactivación de clientes |
| **Módulo** | Clientes |
| **Prioridad** | Baja |
| **Estado** | Implementada |
| **RF Asociados** | RF-004 |
...
**Como** administrador,  
**quiero** desactivar cuentas de clientes inactivas o duplicadas,  
**para** mantener la base de datos depurada sin borrar su historial.

---

## Criterios de Aceptación

### CA-HU-006.1 — Validación de datos y precondiciones
...
### CA-HU-006.2 — Flujo exitoso de operación
...
### CA-HU-006.3 — Control de accesos y persistencia
