...
function Productos() {
  ...
  const manejarAccionProductos = (modulo: string) => {
    ...
    alert(`Accion realizada en el modulo ${modulo}: revisar inventario de productos`);
    console.log(`Accion realizada en el modulo ${modulo}: revisar inventario de productos`);
  };
  ...
  return (
    <div className="card">
      ...
      <CardAccion
        titulo="Productos"
        descripcion="Estado: inventario disponible para revision."
