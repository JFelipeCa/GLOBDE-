    ...
    <div className="landing">
      ...
      <section className="l-hero">
        ...
        <div className="l-hero-stats">
          ...
          <div className="l-stat"><strong className="l-cyan">15</strong><span>Clientes activos</span></div>
          ...
          <div className="l-modal">
            ...
            {tab === 'login' ? (
              <form className="l-modal-body" onSubmit={handleLogin}>
                ...
                <button type="button" className="l-link-button" onClick={() => { cerrarModal(); navigate('/recuperar-contrasena'); }}>Olvide mi contrasena</button>
